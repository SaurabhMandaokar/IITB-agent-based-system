...
def message_handler(message, msg_to_send_queue, paths_dictionary):
    ...
    if protocol in ['fipa request', 'request interaction protocol',
        ...
        handle_fipa_request_protocol(message, msg_to_send_queue, paths_dictionary)
        ...
        handle_fipa_contract_net_protocol(message, msg_to_send_queue, paths_dictionary)
