...
import DownloadableFunctions.SingleMechineSequencing as SingleMachineSequencing
import DownloadableFunctions.machine_condition_monitoring as MachineConditionMonitoring
####################################################################################
def introduction():
...
def execute(performative_type, content):
    if performative_type=='cfp_for_new_job_arrival' or performative_type=='cfp_for_job_of_failed_machine':
        ...
        comments=None
        return {'performative_type': output_performative_type, 'result': output_result, 'comments': comments}
